...
class URL {
    companion object {
        ...
        fun nowPlayingPage(int: Int): String {
            return "https://api.themoviedb.org/3/movie/now_playing?api_key=$apiKey&language=en-US&page=$int"
        }

        fun popularPage(int: Int): String {
            return "https://api.themoviedb.org/3/movie/popular?api_key=$apiKey&language=en-US&page=$int"
        }

        fun topRatedPage(int: Int): String {
            return "https://api.themoviedb.org/3/movie/top_rated?api_key=$apiKey&language=en-US&page=$int"
        }

        fun upcomingPage(int: Int): String {
            return "https://api.themoviedb.org/3/movie/upcoming?api_key=$apiKey&language=en-US&page=$int"
        }
