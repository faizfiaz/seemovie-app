...
class MoviePres @Inject constructor(private val context: Context) : BasePresenter<MovieFragment>(), CallbackConnection {
    ...
    @Inject
    internal lateinit var getNowPlaying: GetNowPLaying
    @Inject
    internal lateinit var getTopRated: GetTopRated
    @Inject
    internal lateinit var getPopular: GetPopular
    @Inject
    internal lateinit var getUpcoming: GetUpcoming
